...
// SOUND EFFECTS
const gameOverSound = new Audio("audio/strange-lullaby.wav");
const clickSound1 = new Audio("audio/boo-and-laugh.wav");
const clickSound2 = new Audio("audio/scary-shout.wav");
